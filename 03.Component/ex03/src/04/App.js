...
export default function App() {
    ...
    const onMouseDownImg = (e) => {
        console.log(`mousedownImg, x=${e.clientX}, y=${e.clientY}`); 
    };

    const onMouseUpImg = (e) => {
        console.log(`mouseupImg, x=${e.clientX}, y=${e.clientY}`); 
    };

    const onClickImg = (e) => {
        console.log(`clickImg, x=${e.clientX}, y=${e.clientY}`); 
    };

    const onDoubleClickImg = (e) => {
        console.log(`doubleClickImg, x=${e.clientX}, y=${e.clientY}`); 
    };
